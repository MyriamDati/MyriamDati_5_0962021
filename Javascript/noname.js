...
const tableBasket = document.querySelector(".card_recap");
  ...
  tableBasket.innerHTML = emptyBasket
    ...
    let fullBasket = `<thead class="thead-dark">
          <tr>
            <th scope="col">Nom</th>
...
const getForm = `
  <form id="formulaire" method="POST" class="w-50 border border-secondary p-3 mt-5">
      ...
      <a href="confirmation.html" type="submit" id="btnConfirm" class="btn btn-dark text-white">Confirmer mon achat</a>
    </form>
  `;
